      ...
      <div className="w-full max-w-md rounded-2xl bg-zinc-200 p-8 shadow-2xl">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="relative">
            ...
            />
            <label
              className="absolute left-4 top-2 text-sm text-zinc-500 transition-all
          ...
          <div className="relative">
            ...
            >
              ...
              <option value="de977148-95d3-4394-91b9-87a3f3594e77">
                Student
              </option>
              <option value="1fe8b0f8-fbf6-4a12-8ce2-2f67215b8b18">
                Instructor
              </option>
            </select>
